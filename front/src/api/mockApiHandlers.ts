...
const mockTours: ApiTour[] = [
  {
    id: 1,
    title: 'Каракумы',
    description: 'Песок, Дарваза, закат — как в рекламе, только честнее.',
    price: 89990,
  ...
  {
    id: 6,
    title: 'Астрахань: вобла и лотосы',
